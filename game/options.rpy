...
define config.name = _("Portal to the world of education")
...
define build.name = "Portaltotheworldofeducation"
...
define config.save_directory = "Portaltotheworldofeducation-1765531653"
